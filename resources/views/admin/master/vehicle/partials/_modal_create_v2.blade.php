<div class="modal fade zoom modal-create-v2">
            ...
            <div class="modal-body">
                <form method="post">
                    ...
                    <div class="row g-gs">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="form-label" for="">Maximum Person(Nama Karyawan)</label>
                                <div class="form-control-wrap">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="">Direction(Tujuan)</label>
                                <div class="form-control-wrap">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="">Necessity(Keperluan)</label>
                                <div class="form-control-wrap">
