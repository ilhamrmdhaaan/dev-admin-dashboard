<div class="nk-tb-list is-separate mb-3">
    ...
    <div class="nk-tb-item">
        ...
        <div class="nk-tb-col tb-col-md">
            <span class="badge badge-dim badge @if($item->status == 'pending') badge-warning @endif">
            {{-- <span class="badge badge-dim badge badge-warning"> --}}
                {!! $item->status !!}
            </span>
        </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <ul class="link-list-opt no-bdr">
                                <li>
                                    <a href="#" onclick="showModalUpdated(`{{ route('request-vehicle.show', $item->id) }}`, `{{ route('request-vehicle.update', $item->id) }}`)">
